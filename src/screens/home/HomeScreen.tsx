  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        contentContainerStyle={{ paddingBottom: 20 }} // Giảm padding vì không còn Tab che
        renderItem={({ item }) => (
          <ProductCard 
            name={item.name} 
            price={item.price} 
      ...
      {/* ĐÃ XÓA PHẦN BOTTOM NAVIGATION TẠI ĐÂY */}
    </SafeAreaView>
  );
};
...
const styles = StyleSheet.create({
  ...
  // Đã xóa styles của bottomTab, tabItem và activeUnderline
});
