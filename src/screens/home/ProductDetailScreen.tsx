  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageSection}>
        <Image 
          source={{ uri: 'https://images.unsplash.com/photo-1538688525198-9b88f6f53126?q=80&w=1000' }} 
          style={styles.mainImage} 
        />
        
        {/* Nút Back ô vuông bo góc 12 */}
        <TouchableOpacity style={styles.backBtn} onPress={() => navigation.goBack()}>
          <Ionicons name="chevron-back" size={24} color="#303030" />
        </TouchableOpacity>

        {/* Thanh chọn màu dọc bên trái ảnh */}
      ...
      <ScrollView style={styles.infoSection} showsVerticalScrollIndicator={false}>
        <Text style={styles.productName}>Minimal Stand</Text>
        ...
        <Text style={styles.description}>
          ...
          This is one of the best furniture in this year. It fits with any kind of home design.
        </Text>
      </ScrollView>

      {/* 3. VÙNG NÚT HÀNH ĐỘNG DƯỚI CÙNG */}
      <View style={styles.footer}>
        <TouchableOpacity style={styles.bookmarkBtn}>
          <Ionicons name="bookmark-outline" size={24} color="#303030" />
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  productName: { fontSize: 30, fontWeight: '600', color: '#303030' }, // Serif style
